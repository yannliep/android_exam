...
public class ContactViewModel extends AndroidViewModel {
    ...
    public ContactViewModel(@NonNull Application application) {
        ...
        contactDAO = Database.getInstance(application.getApplicationContext()).contactDAO();
    }
    ...
    private static class InsertOrUpdateTask extends AsyncTask<Contact, Void, Void>{
        private ContactDAO contactDAO;
